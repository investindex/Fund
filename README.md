...
See the [section on taxes](https://github.com/investindex/Taxes#the-tax-issue-with-global-funds) for the minor tax incentive to split VT into total US (SCHB) and total international (VXUS) funds in taxable accounts (but _not_ in tax-advantaged accounts). The couch potato portfolio holds the global fund AVGE in the Roth IRA quite deliberately for the same reason.
